...
static void mov_instr(memory_t*,  cpu_model_t*);
static void ora_instr(memory_t*,  cpu_model_t*);
static void rz_instr(memory_t*,  cpu_model_t*);
static void ldax_instr(memory_t*,  cpu_model_t*);
static void inx_instr(memory_t*,  cpu_model_t*);
static void dcx_instr(memory_t*,  cpu_model_t*);
static void jnz_instr(memory_t*,  cpu_model_t*);
static void ret_instr(memory_t*,  cpu_model_t*);
static void nop_instr(memory_t*,  cpu_model_t*);
static void stax_instr(memory_t*,  cpu_model_t*);
static void inr_instr(memory_t*,  cpu_model_t*);
static void dcr_instr(memory_t*,  cpu_model_t*);
static void mvi_instr(memory_t*,  cpu_model_t*);
static void rlc_instr(memory_t*,  cpu_model_t*);
static void lxi_instr(memory_t*,  cpu_model_t*);
static void dcr_instr(memory_t*,  cpu_model_t*);
static void dad_instr(memory_t*,  cpu_model_t*);
static void rrc_instr(memory_t*,  cpu_model_t*);
static void ral_instr(memory_t*,  cpu_model_t*);
static void rar_instr(memory_t*,  cpu_model_t*);
static void shld_instr(memory_t*,  cpu_model_t*);
static void daa_instr(memory_t*,  cpu_model_t*);
static void lhld_instr(memory_t*,  cpu_model_t*);
static void cma_instr(memory_t*,  cpu_model_t*);
static void sta_instr(memory_t*,  cpu_model_t*);
static void stc_instr(memory_t*,  cpu_model_t*);
static void lda_instr(memory_t*,  cpu_model_t*);
static void cmc_instr(memory_t*,  cpu_model_t*);
static void hlt_instr(memory_t*,  cpu_model_t*);
static void add_instr(memory_t*,  cpu_model_t*);
static void adc_instr(memory_t*,  cpu_model_t*);
static void sub_instr(memory_t*,  cpu_model_t*);
static void sbb_instr(memory_t*,  cpu_model_t*);
static void ana_instr(memory_t*,  cpu_model_t*);
static void xra_instr(memory_t*,  cpu_model_t*);
static void cmp_instr(memory_t*,  cpu_model_t*);
static void rnz_instr(memory_t*,  cpu_model_t*);
static void pop_instr(memory_t*,  cpu_model_t*);
static void jmp_instr(memory_t*,  cpu_model_t*);
static void cnz_instr(memory_t*,  cpu_model_t*);
static void push_instr(memory_t*,  cpu_model_t*);
static void adi_instr(memory_t*,  cpu_model_t*);
static void rst_instr(memory_t*,  cpu_model_t*);
static void jz_instr(memory_t*,  cpu_model_t*);
static void cz_instr(memory_t*,  cpu_model_t*);
static void call_instr(memory_t*,  cpu_model_t*);
static void aci_instr(memory_t*,  cpu_model_t*);
static void rnc_instr(memory_t*,  cpu_model_t*);
static void jnc_instr(memory_t*,  cpu_model_t*);
static void out_instr(memory_t*,  cpu_model_t*);
static void cnc_instr(memory_t*,  cpu_model_t*);
static void sui_instr(memory_t*,  cpu_model_t*);
static void rc_instr(memory_t*,  cpu_model_t*);
static void jc_instr(memory_t*,  cpu_model_t*);
static void in_instr(memory_t*,  cpu_model_t*);
static void cc_instr(memory_t*,  cpu_model_t*);
static void sbi_instr(memory_t*,  cpu_model_t*);
static void rpo_instr(memory_t*,  cpu_model_t*);
static void jpo_instr(memory_t*,  cpu_model_t*);
static void xthl_instr(memory_t*,  cpu_model_t*);
static void cpo_instr(memory_t*,  cpu_model_t*);
static void ani_instr(memory_t*,  cpu_model_t*);
static void rpe_instr(memory_t*,  cpu_model_t*);
static void pchl_instr(memory_t*,  cpu_model_t*);
static void jpe_instr(memory_t*,  cpu_model_t*);
static void xchg_instr(memory_t*,  cpu_model_t*);
static void cpe_instr(memory_t*,  cpu_model_t*);
static void xri_instr(memory_t*,  cpu_model_t*);
static void rp_instr(memory_t*,  cpu_model_t*);
static void jp_instr(memory_t*,  cpu_model_t*);
static void di_instr(memory_t*,  cpu_model_t*);
static void cp_instr(memory_t*,  cpu_model_t*);
static void ori_instr(memory_t*,  cpu_model_t*);
static void rm_instr(memory_t*,  cpu_model_t*);
static void sphl_instr(memory_t*,  cpu_model_t*);
static void jm_instr(memory_t*,  cpu_model_t*);
static void ei_instr(memory_t*,  cpu_model_t*);
static void cm_instr(memory_t*,  cpu_model_t*);
static void cpi_instr(memory_t*,  cpu_model_t*);

static void empty_instr(memory_t*,  cpu_model_t*);

/* Table taken fmem http://pastraiser.com/cpu/i8080/i8080_opcodes.html */
static void (*assembly_instr[]) (memory_t*,  cpu_model_t*) =
{
...
{
    cpu->core.status.bits.p = (reg&=0x01) ? 0 : 1;
}
...
// ---------------------------------------------------------------
OPCODE_FUNC(cmc_instr)(memory_t* mem, cpu_model_t* cpu)
{
    cpu->core.status.bits.c = (cpu->core.status.bits.c == 0) ? 1 : 0;
    INCR_PC_CNT(cpu);
}

OPCODE_FUNC(stc_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
// ---------------------------------------------------------------
OPCODE_FUNC(inr_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
OPCODE_FUNC(dcr_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
    uint8_t *reg = common_func_get_reg(cpu, opcode);
...
OPCODE_FUNC(cma_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
OPCODE_FUNC(daa_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
//                 NOP INSTRUCTIONS
// ---------------------------------------------------------------
OPCODE_FUNC(nop_instr)(memory_t* mem, cpu_model_t* cpu)
{
    INCR_PC_CNT(cpu);
}
...
// ---------------------------------------------------------------
OPCODE_FUNC(mov_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
    uint16_t addr = 0x00;
...
OPCODE_FUNC(stax_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
    ...
    mem->memory[address] = cpu->core.a;

    INCR_PC_CNT(cpu);
}

OPCODE_FUNC(ldax_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
    uint16_t address = 0x00;
...
OPCODE_FUNC(ora_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
    uint16_t addr = (cpu->core.h << 8) | cpu->core.l;
    ...
    switch (opcode) {
        ...
        case 0xB5:
            ...
            break;
        case 0xB6:
            ora_register_value(mem->memory[addr], cpu);
            break;
        case 0xB7:
...
OPCODE_FUNC(add_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
    uint16_t addr = (cpu->core.h << 8) | cpu->core.l;
    ...
    switch (opcode) {
        ...
        case 0x85:
            ...
            break;
        case 0x86:
            add_register_value(mem->memory[addr], cpu);
            break;
        case 0x87:
...
OPCODE_FUNC(adc_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
    uint16_t addr = (cpu->core.h << 8) | cpu->core.l;
    ...
    switch (opcode) {
        ...
        case 0x8D:
            ...
            break;
        case 0x8E:
            adc_register_value(mem->memory[addr], cpu);
            break;
        case 0x8F:
...
OPCODE_FUNC(sub_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
    uint16_t addr = (cpu->core.h << 8) | cpu->core.l;
    ...
    switch (opcode) {
        ...
        case 0x95:
            ...
            break;
        case 0x96:
            sub_register_value(mem->memory[addr], cpu);
            break;
        case 0x97:
...
OPCODE_FUNC(sbb_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
    uint16_t addr = (cpu->core.h << 8) | cpu->core.l;
    ...
    switch (opcode) {
        ...
        case 0x9D:
            ...
            break;
        case 0x9E:
            sbb_register_value(mem->memory[addr], cpu);
            break;
        case 0x9F:
...
OPCODE_FUNC(ana_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
    uint16_t addr = (cpu->core.h << 8) | cpu->core.l;
    ...
    switch (opcode) {
        ...
        case 0xA5:
            ...
            break;
        case 0xA6:
            ana_register_value(mem->memory[addr], cpu);
            break;
        case 0xA7:
...
OPCODE_FUNC(xra_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
    uint16_t addr = (cpu->core.h << 8) | cpu->core.l;
    ...
    switch (opcode) {
        ...
        case 0xAD:
            ...
            break;
        case 0xAE:
            xra_register_value(mem->memory[addr], cpu);
            break;
        case 0xAF:
...
OPCODE_FUNC(cmp_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
    uint16_t addr = (cpu->core.h << 8) | cpu->core.l;
    ...
    switch (opcode) {
        ...
        case 0xBD:
            ...
            break;
        case 0xBE:
            cmp_register_value(mem->memory[addr], cpu);
            break;
        case 0xBF:
...
// ---------------------------------------------------------------
OPCODE_FUNC(rlc_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
OPCODE_FUNC(rrc_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
OPCODE_FUNC(ral_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t hbit = ((cpu->core.a & 0x80) != 0);
...
OPCODE_FUNC(rar_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t lbit = ((cpu->core.a & 0x01) != 0);
    uint8_t cbit = cpu->core.status.bits.c;
...
// ---------------------------------------------------------------
static inline void push_on_the_stack(uint8_t hbit, uint8_t lbit, memory_t *mem, cpu_model_t *cpu)
{
    mem->memory[--(cpu->core.stack)] = hbit;
    mem->memory[--(cpu->core.stack)] = lbit;
}

static inline void pop_fmem_the_stack(uint8_t *hbit, uint8_t *lbit, memory_t *mem, cpu_model_t *cpu)
{
    *lbit = mem->memory[(cpu->core.stack)++];
    *hbit = mem->memory[(cpu->core.stack)++];
}

OPCODE_FUNC(push_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
    switch (opcode) {
        case 0xC5:
            push_on_the_stack(cpu->core.b, cpu->core.c, mem, cpu);
            break;
        case 0xD5:
            push_on_the_stack(cpu->core.d, cpu->core.e, mem, cpu);
            break;
        case 0xE5:
            push_on_the_stack(cpu->core.h, cpu->core.l, mem, cpu);
            break;
        case 0xF5:
            push_on_the_stack(cpu->core.a, cpu->core.status.reg, mem, cpu);
            break;
    }
...
OPCODE_FUNC(pop_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];

    switch (opcode) {
        case 0xC1:
            pop_fmem_the_stack(&cpu->core.b, &cpu->core.c, mem, cpu);
            break;
        case 0xD1:
            pop_fmem_the_stack(&cpu->core.b, &cpu->core.c, mem, cpu);
            break;
        case 0xE1:
            pop_fmem_the_stack(&cpu->core.h, &cpu->core.l, mem, cpu);
            break;
        case 0xF1:
            pop_fmem_the_stack(&cpu->core.a, &cpu->core.status.reg, mem, cpu);
            break;
    }
...
OPCODE_FUNC(dad_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
...
OPCODE_FUNC(inx_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
    uint16_t prod = 0;
...
OPCODE_FUNC(dcx_instr)(memory_t* mem, cpu_model_t *cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
    uint16_t prod = 0;
...
OPCODE_FUNC(xchg_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
OPCODE_FUNC(xthl_instr)(memory_t* mem, cpu_model_t* cpu)
{
    mem->memory[cpu->core.stack] = cpu->core.l;
    mem->memory[cpu->core.stack +1] = cpu->core.h;

    INCR_PC_CNT(cpu);
}

OPCODE_FUNC(sphl_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
// ---------------------------------------------------------------
OPCODE_FUNC(mvi_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];
    uint8_t data = mem->memory[cpu->core.pc+1];
    uint16_t addr = (cpu->core.h << 8) | cpu->core.l;
...
OPCODE_FUNC(adi_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t data  = mem->memory[cpu->core.pc + 1];
...
OPCODE_FUNC(aci_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t data = mem->memory[cpu->core.pc + 1];
    uint8_t cbit = cpu->core.status.bits.c != 0;
...
OPCODE_FUNC(sui_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t data = mem->memory[cpu->core.pc + 1];
...
OPCODE_FUNC(sbi_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t data = mem->memory[cpu->core.pc + 1];
    uint8_t cbit = cpu->core.status.bits.c != 0;
...
OPCODE_FUNC(ani_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t data = mem->memory[cpu->core.pc + 1];
...
OPCODE_FUNC(xri_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t data = mem->memory[cpu->core.pc + 1];
...
OPCODE_FUNC(ori_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t data = mem->memory[cpu->core.pc + 1];
...
OPCODE_FUNC(cpi_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t data = mem->memory[cpu->core.pc + 1];
...
static uint16_t get_direct_address_fmem_mem(memory_t *mem, cpu_model_t *cpu);

OPCODE_FUNC(lxi_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[cpu->core.pc];

    switch(opcode) {
        case 0x01:
            cpu->core.c = mem->memory[cpu->core.pc + 1];
            cpu->core.b = mem->memory[cpu->core.pc + 2];
            break;
        case 0x11:
            cpu->core.e = mem->memory[cpu->core.pc + 1];
            cpu->core.d = mem->memory[cpu->core.pc + 2];
            break;
        case 0x21:
            cpu->core.l = mem->memory[cpu->core.pc + 1];
            cpu->core.h = mem->memory[cpu->core.pc + 2];
            break;
        case 0x31:
            cpu->core.stack = get_direct_address_fmem_mem(mem, cpu);
            break;
    }
...
OPCODE_FUNC(sta_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint16_t addr = get_direct_address_fmem_mem(mem, cpu);
...
OPCODE_FUNC(lda_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint16_t addr = get_direct_address_fmem_mem(mem, cpu);
...
OPCODE_FUNC(shld_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint16_t addr = get_direct_address_fmem_mem(mem, cpu);

    mem->memory[addr] = cpu->core.l;
    mem->memory[addr +1] = cpu->core.h;

    INCR_PC_X_CNT(cpu, 3);
}

OPCODE_FUNC(lhld_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint16_t addr = get_direct_address_fmem_mem(mem, cpu);

    cpu->core.l = mem->memory[addr];
    cpu->core.h = mem->memory[addr+1];
...
// 		JUMP INSTRUCTIONS
// ---------------------------------------------------------------
OPCODE_FUNC(pchl_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
OPCODE_FUNC(jmp_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint16_t addr = get_direct_address_fmem_mem(mem, cpu);
...
OPCODE_FUNC(jc_instr)(memory_t* mem, cpu_model_t* cpu)
{
    if (cpu->core.c == 1) {
        uint16_t addr = get_direct_address_fmem_mem(mem, cpu);
        SET_PC_CNT(cpu, addr);
...
OPCODE_FUNC(jnc_instr)(memory_t* mem, cpu_model_t* cpu)
{
    if (cpu->core.c == 0) {
        uint16_t addr = get_direct_address_fmem_mem(mem, cpu);
        SET_PC_CNT(cpu, addr);
...
OPCODE_FUNC(jz_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
OPCODE_FUNC(jnz_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
OPCODE_FUNC(jm_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
OPCODE_FUNC(jp_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
OPCODE_FUNC(jpe_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
OPCODE_FUNC(jpo_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
// ---------------------------------------------------------------
OPCODE_FUNC(call_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint16_t pc_to_store = cpu->core.pc + 3;
    uint8_t hbit = (pc_to_store >> 8) & 0xFF;
    uint8_t lbit = pc_to_store & 0xFF;
    uint8_t l_addr_bit = mem->memory[cpu->core.pc+1];
    uint8_t h_addr_bit = mem->memory[cpu->core.pc+2];

    push_on_the_stack(hbit, lbit, mem, cpu);

    cpu->core.pc = (h_addr_bit << 8) | l_addr_bit;
}

OPCODE_FUNC(cc_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
OPCODE_FUNC(cnc_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
OPCODE_FUNC(cz_instr)(memory_t* mem, cpu_model_t* cpu)
{
    if (cpu->core.status.bits.z == 1) {
        call_instr(mem, cpu);
    }
...
OPCODE_FUNC(cnz_instr)(memory_t* mem, cpu_model_t* cpu)
{
    if (cpu->core.status.bits.z == 0) {
        call_instr(mem, cpu);
    }
...
OPCODE_FUNC(cm_instr)(memory_t* mem, cpu_model_t* cpu)
{
    if (cpu->core.status.bits.s == 0) {
        call_instr(mem, cpu);
    }
...
OPCODE_FUNC(cp_instr)(memory_t* mem, cpu_model_t* cpu)
{
    if (cpu->core.status.bits.s == 1) {
        call_instr(mem, cpu);
    }
...
OPCODE_FUNC(cpe_instr)(memory_t* mem, cpu_model_t* cpu)
{
    if (cpu->core.status.bits.p == 1) {
        call_instr(mem, cpu);
    }
...
OPCODE_FUNC(cpo_instr)(memory_t* mem, cpu_model_t* cpu)
{
    if (cpu->core.status.bits.p == 0) {
        call_instr(mem, cpu);
    }
...
// ---------------------------------------------------------------
// 		RETURN Fmem SUBROUTINE INSTRUCTIONS
// ---------------------------------------------------------------
static void return_instr(memory_t *mem, cpu_model_t *cpu)
{
    uint8_t hbit = 0;
    uint8_t lbit = 0;

    pop_fmem_the_stack(&hbit, &lbit, mem, cpu);

    cpu->core.pc = (hbit << 8) | lbit;
}

OPCODE_FUNC(ret_instr)(memory_t* mem, cpu_model_t* cpu)
{
    return_instr(mem, cpu);
}

OPCODE_FUNC(rz_instr)(memory_t* mem, cpu_model_t* cpu)
{
    if (cpu->core.status.bits.z = 1) {
        return_instr(mem, cpu);
    }
...
OPCODE_FUNC(rnz_instr)(memory_t* mem, cpu_model_t* cpu)
{
    if (cpu->core.status.bits.z = 1) {
        return_instr(mem, cpu);
    }
...
OPCODE_FUNC(rc_instr)(memory_t* mem, cpu_model_t* cpu)
{
    if (cpu->core.status.bits.c = 1) {
        return_instr(mem, cpu);
    }
...
OPCODE_FUNC(rnc_instr)(memory_t* mem, cpu_model_t* cpu)
{
    if (cpu->core.status.bits.c = 0) {
        return_instr(mem, cpu);
    }
...
OPCODE_FUNC(rm_instr)(memory_t* mem, cpu_model_t* cpu)
{
    if (cpu->core.status.bits.s = 1) {
        return_instr(mem, cpu);
    }
...
OPCODE_FUNC(rp_instr)(memory_t* mem, cpu_model_t* cpu)
{
    if (cpu->core.status.bits.s = 0) {
        return_instr(mem, cpu);
    }
...
OPCODE_FUNC(rpe_instr)(memory_t* mem, cpu_model_t* cpu)
{
    if (cpu->core.status.bits.p = 1) {
        return_instr(mem, cpu);
    }
...
OPCODE_FUNC(rpo_instr)(memory_t* mem, cpu_model_t* cpu)
{
    if (cpu->core.status.bits.p = 0) {
        return_instr(mem, cpu);
    }
...
OPCODE_FUNC(rst_instr)(memory_t* mem, cpu_model_t* cpu)
{
    uint8_t opcode = mem->memory[0];
...
// ---------------------------------------------------------------
OPCODE_FUNC(di_instr)(memory_t* mem, cpu_model_t* cpu)
{
    cpu->interrupt_enable = false;
    INCR_PC_CNT(cpu);
}

OPCODE_FUNC(ei_instr)(memory_t* mem, cpu_model_t* cpu)
{
...
// ---------------------------------------------------------------
OPCODE_FUNC(out_instr)(memory_t* mem, cpu_model_t* cpu)
{
    INCR_PC_X_CNT(cpu, 2);
}

OPCODE_FUNC(in_instr)(memory_t* mem, cpu_model_t* cpu)
{
    INCR_PC_X_CNT(cpu, 2);
}
...
// 		HALT INSTRUCTIONS
// ---------------------------------------------------------------
OPCODE_FUNC(hlt_instr)(memory_t* mem, cpu_model_t* cpu)
{
    INCR_PC_CNT(cpu);
...
{
    uint16_t opcode = mem->memory[0];

    (*assembly_instr[opcode])(mem, cpu_8080);
}
...
void execute_cpu(memory_t* mem, cpu_model_t* cpu_8080)   {
    ...
    while(mem->memory_size > cpu_8080->core.pc)   {
        ...
        if(cpu_8080->is_running == 1)
        {
            ...
            uint16_t opcode  = mem->memory[cpu_8080->core.pc];
